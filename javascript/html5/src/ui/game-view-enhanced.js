...
const logger = new Logger("scopa:game-view");
...
export class GameView {
  ...
  renderMenu() {
    ...
    instructions.innerHTML = `
      <h3>How to Play</h3>
      <ul>
        <li><strong>Objective:</strong> Reach the target score and lead by 2 points (default target: 11)</li>
        <li><strong>Scoring:</strong> Most cards, most denari, settebello, primiera, and scope</li>
        ...
        <li><strong>Scopa:</strong> Clear the table completely to score a sweep!</li>
        <li><strong>Win Condition:</strong> First player to hit the configured target with a 2-point lead wins</li>
      </ul>
    `;
  ...
  showMoveResolution(moveType, cards) {
    ...
    } else if (moveType === "Scopa") {
      message = "🧹 Scopa! Swept the table!";
