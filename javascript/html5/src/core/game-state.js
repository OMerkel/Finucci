...
export class GameState {
  constructor(config = {}) {
    // Game configuration
    this.targetScore = config.targetScore || 11;
    this.settantaMethod = config.settantaMethod ?? "numerical"; // "prime" | "simplified" | "numerical"
    ...
    this.enableFinalCardScopa = config.enableFinalCardScopa ?? false;
    ...
    // Turn state
    this.lastCapture = null; // For Scopa detection
