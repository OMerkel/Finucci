...
describe("UI Integration", () => {
  ...
  describe("Game Board Rendering", () => {
    it("should render game board", () => {
      // Given: game state
      const gameState = {
        tableCards: [new Card("denari", "3", 3), new Card("coppe", "2", 2)],
        hands: [[new Card("denari", "5", 5)], [new Card("coppe", "3", 3)]],
        captured: [[], []],
      };
  ...
  describe("User Input Handling", () => {
    ...
    it("should be accessible (WCAG 2.1 AA)", () => {
      // Given: rendered game
      const gameState = {
        tableCards: [new Card("denari", "3", 3)],
        hands: [[new Card("denari", "5", 5)]],
        captured: [[], []],
      };
      ui.renderBoard(gameState);
  ...
  describe("Game State Rendering", () => {
    it("should render game state to string", () => {
      ...
      const gameState = {
        tableCards: [new Card("denari", "3", 3)],
        hands: [[new Card("denari", "5", 5)], [new Card("coppe", "2", 2)]],
        captured: [[new Card("spade", "7", 7)], []],
      };
      ...
      expect(rendered).toContain("3 di denari");
    });
  });
});
