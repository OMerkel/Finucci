 ...
 * Requirements: FR-15.1, FR-15.2, FR-17.1 (MCTS AI strategy)
 */
...
describe("AI Strategy - MCTS", () => {
  describe("MCTS Node", () => {
    it("should perform tree selection with UCB1", () => {
      ...
      const child1 = new MCTSNode({ card: new Card("denari", "5", 5) }, root);
      const child2 = new MCTSNode({ card: new Card("coppe", "3", 3) }, root);
    ...
    it("should prefer unvisited nodes in UCB1", () => {
      ...
      const root = new MCTSNode();
      const visited = new MCTSNode({ card: new Card("denari", "5", 5) }, root);
      const unvisited = new MCTSNode({ card: new Card("coppe", "3", 3) }, root);
  ...
  describe("Tree Operations", () => {
    it("should expand tree nodes", () => {
      ...
      const node = new MCTSNode();
      const moves = [new Card("denari", "5", 5), new Card("coppe", "3", 3)];
    ...
    it("should select node via UCB1", () => {
      // Given: MCTS tree
      const root = new MCTSNode();
      const level1 = new MCTSNode({ card: new Card("denari", "5", 5) }, root);
      const level2 = new MCTSNode({ card: new Card("coppe", "3", 3) }, level1);
    ...
    it("should backpropagate statistics", () => {
      ...
      const root = new MCTSNode();
      const child = new MCTSNode({ card: new Card("denari", "5", 5) }, root);
      root.addChild(child);
  ...
  describe("MCTS Search", () => {
    ...
    it("should respect time limits", () => {
      ...
      const hand = [new Card("denari", "5", 5), new Card("coppe", "3", 3)];
      const tableCards = [];
      const maxTime = 300;
    ...
    it("should select move using MCTS strategy", () => {
      ...
      const hand = [new Card("denari", "5", 5), new Card("coppe", "2", 2)];
      const tableCards = [];
      const gameState = {
        currentPlayerIndex: 0,
        scores: [8, 5],
