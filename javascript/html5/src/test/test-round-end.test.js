 ...
 * Requirements: FR-7.1, FR-7.2 (Round end mechanics)
 */
...
describe("Round End Mechanics", () => {
  ...
  beforeEach(() => {
    ...
    player2 = {
      name: "Player 2",
      hand: [],
      pile: [new Card("coppe", "asso"), new Card("coppe", "2")],
      Scope: 0,
    };

    tableCards = [new Card("spade", "7"), new Card("bastoni", "5")];
  });
