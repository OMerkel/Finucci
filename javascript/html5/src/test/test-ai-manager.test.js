 ...
 * Requirements: FR-12.1, FR-12.2, FR-12.3, FR-12.4, FR-15.1
 */
...
describe("AI Manager", () => {
  ...
  describe("Move Execution", () => {
    ...
    it("should respect response time limits", async () => {
      // Given: strategy execution under a configured timeout
      const slowStrategy = (hand, table) => {
        void table;
        // Simulated strategy body
  ...
  describe("Move Validation", () => {
    it("should validate AI move before execution", () => {
      // Given: valid Scopa move (exact match)
      const card = new Card("denari", "7", 7);
      const hand = [card, new Card("coppe", "2", 2)];
      const table = [new Card("bastoni", "7", 7)];
      const move = {
        card,
        isCapture: true,
        capture: table,
    ...
    it("should reject move with card not in hand", () => {
      ...
      const cardNotInHand = new Card("spade", "7", 7);
      const hand = [new Card("denari", "5", 5)];
      const table = [];
    ...
    it("should reject move with invalid capture", () => {
      ...
      const captureCard = new Card("coppe", "3", 3);
      const hand = [card];
